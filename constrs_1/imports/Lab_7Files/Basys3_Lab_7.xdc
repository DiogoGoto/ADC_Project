...
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports adc_sel_in];     #[get_ports btnD]
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports comp_r2r];#Sch name = JB1
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports comp_pwm];#Sch name = JB2
...
#set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports comparator];#Sch name = XA2_P
